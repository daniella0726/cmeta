...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { cargo: @estudiante.cargo, carrera: @estudiante.carrera, empresa: @estudiante.empresa, encuestador: @estudiante.encuestador, nombre: @estudiante.nombre, revisor: @estudiante.revisor, semestre: @estudiante.semestre, supervisor: @estudiante.supervisor, trabaja: @estudiante.trabaja, universidad: @estudiante.universidad } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { cargo: @estudiante.cargo, carrera: @estudiante.carrera, empresa: @estudiante.empresa, encuestador: @estudiante.encuestador, nombre: @estudiante.nombre, revisor: @estudiante.revisor, semestre: @estudiante.semestre, supervisor: @estudiante.supervisor, trabaja: @estudiante.trabaja, universidad: @estudiante.universidad } }
